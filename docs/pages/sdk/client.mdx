...
- `updateSchedule(schedulePda: PublicKey, params)` - Update a paused schedule (advanced)
- `updateScheduleFromRecipients(params)` - Update a paused schedule and rebuild its Merkle root from recipients
