...
- `solana` (default) executes payout claims on the base Solana RPC
- `er` executes payout claims on the ER RPC
- Keep this on `solana` unless your token-account flow is explicitly built for ER writes
